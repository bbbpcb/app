    ...
    <td><?=$v['realname']?></td>      
        ...
        <td width="113" valign="middle">
          <!--<a href="<?=base_url()?>index.php?d=home&c=question&m=update&id=<?=$v['id']?>">编辑</a> | -->
            <a href="<?=base_url()?>index.php?d=home&c=question&m=reply&id=<?=$v['id']?>">回答</a> | 
            <a href="javascript:void(0);" onClick="flush('删除后不能恢复，确定删除吗?','<?=base_url()?>index.php?d=home&c=question&m=del&id=<?=$v['id']?>');">删除</a> 
          </td>
    </tr>
	<?php
		}
