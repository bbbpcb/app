  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <a href="<?=base_url()?>index.php?d=home&c=member&m=add"><li class="active"><button type="button" class="btn btn-default navbar-btn">添加</button></li></a>

      </ul>
      <form class="navbar-form navbar-left" role="search"  method="post"  action="<?=base_url()?>index.php?d=home&c=member&m=index">
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <td valign="middle"><?=$v['jobs_name']?></td>
		...
		<a href="javascript:void(0);" onClick="flush('删除后不能恢复，确定删除吗?','<?=base_url()?>index.php?d=home&c=member&m=del&id=<?=$v['id']?>')">删除</a> | 
		<a href="<?=base_url()?>index.php?d=home&c=member&m=ex&id=<?=$v['id']?>">关联专家</a>
    </td>
    </tr>
