...
<section id="wrap">
  ...
  <ul class="aui-list aui-media-list project dotask ">
    ...
    <li class="aui-list-item aui-list-item-middle">
      ...
      <img  style="width:2.5rem" src="<?=$v['headerurl']?>" class="aui-img-round aui-list-img-sm"> 
      <div class="name"> 
            <?=$v['realname']?>
            </div>
               <div class="C"></div>
        ...
        <div class="aui-list-item-inner">
          <div class="aui-list-item-text">
            ...
            <a href="<?=base_url()?>index.php?d=api&c=dotask&m=dotask_detail&taskid=<?=$v["taskid"]?>&typeid=<?=$v["typeid"]?>&membertaskmid=<?=$v["mid"]?>&typerole=2<?=$_GET['m']=='dotask_score'?'&make=1':''?>">
               <?=$v['title']?>
            </a>
