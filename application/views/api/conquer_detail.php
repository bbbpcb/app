...
<body>
<header class="aui-bar aui-bar-nav aui-bar-warning" id="aui-header"> <a class="aui-pull-left aui-btn<?php if($_GET['t'] == 1){?> abs<?php } ?>" href="javascript:history.go(-1);"> <span class="aui-iconfont aui-icon-left"></span> </a>
  <div class="aui-title">复盘详情</div>                                                 
  <?php if($_GET['t'] == 1){?><a class="aui-pull-right aui-btn" id="topr" href="<?=base_url()?>?d=api&c=conquer&m=conquer_create&cid=<?=$_GET['cid']?>"  >修改</a><?php } ?>
</header>
