...
(function(){
	...
	window.scrollBar=function(oDiv,oUl,options)
	{
		...
		this.sTiao.className='scroll_tiao';
		...
		this.dir=this.direction=='right'?true:this.direction=='bottom'?false:function(){ alert('"direction"参数不对,只能是:right或者bottom');};
