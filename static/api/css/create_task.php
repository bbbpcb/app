...
<section id="main-info">
  <header class="aui-bar aui-bar-nav aui-bar-warning" id="aui-header"> <a class="aui-pull-left aui-btn abs" href="javascript:;window.history.go(-1)"> <span class="aui-iconfont aui-icon-left"></span> </a> 创建 </header>
  <section id="wrap" class="pro-det">
    ...
    <section class="aui-chat" id="chat">
      <div class="send"> 提示：点击保存，可返回工作模块页面，选择新的模块在创建新的任务。
