...
<section id="main-info">
  <header class="aui-bar aui-bar-nav aui-bar-warning" id="aui-header"> <a class="aui-pull-left aui-btn abs" href="javascript:;window.history.go(-1)"> <span class="aui-iconfont aui-icon-left"></span> </a> 发起 </header>
 ...
 $("#basics").click(function(){
    ...
    function(res) {
        ...
        if (res.errcode < 0) {
			...
			window.location.href="<?=base_url()?>index.php?d=api&c=review&m=review_list&types=2";
